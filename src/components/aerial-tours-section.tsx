...
import { Clock, Users, MapPin, ArrowRight, Zap } from "lucide-react"
...
const tours = [
  ...
  },
  {
    ...
    description: "Vuela sobre los impresionantes paisajes patagónicos, con vistas a la cordillera y los lagos de la región.",
  ...
  <div className="absolute top-4 right-4 bg-black text-white px-3 py-1 rounded-full font-bold text-sm flex items-center z-10">
    ...
    ¡OFERTA ESPECIAL!
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
        {/* Título que solo aparece al hacer hover */}
        <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <Button 
              variant="outline" 
              className="bg-transparent border-white/50 text-white hover:bg-white/10 group"
            >
              Reservar
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-sky-500"
          >
            Paseos Aéreos
          </motion.h1>
          <motion.p
